...
const BitcoinRefreshIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => (
    <svg
      width="100%"
      height="100%"
    ...
    >
      ...
      ></path>
      <path
        d="M2.73999 9.67993V11.9999C2.73999 17.1199 6.88999 21.2599 12 21.2599C14.92 21.2599 17.53 19.8999 19.23 17.7899"
        stroke="var(--icon-stroke, inherit)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
BitcoinRefreshIcon.displayName = "BitcoinRefreshIcon";
