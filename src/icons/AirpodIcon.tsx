...
const AirpodIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => (
    <svg
      width="100%"
      height="100%"
    ...
    >
      ...
      ></path>
      <path
        d="M17.1301 8.92C17.1301 10.05 16.2101 10.97 15.0801 10.97H8.92012C8.36012 10.97 7.84012 10.74 7.47012 10.36C7.10012 9.99998 6.87012 9.49 6.87012 8.92C6.87012 7.79 7.79012 6.87 8.92012 6.87H15.0701C15.6301 6.87 16.1501 7.1 16.5201 7.48C16.9001 7.85 17.1301 8.36 17.1301 8.92Z"
        stroke="var(--icon-stroke, inherit)"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
AirpodIcon.displayName = "AirpodIcon";
