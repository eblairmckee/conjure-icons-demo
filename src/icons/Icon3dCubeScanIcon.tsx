...
const Icon3dCubeScanIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => (
    <svg
      width="100%"
      height="100%"
...
Icon3dCubeScanIcon.displayName = "Icon3dCubeScanIcon";

export default Icon3dCubeScanIcon;
