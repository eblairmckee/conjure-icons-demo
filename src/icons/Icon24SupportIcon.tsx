...
const Icon24SupportIcon = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
  (props, ref) => (
    <svg
      width="100%"
      height="100%"
...
Icon24SupportIcon.displayName = "Icon24SupportIcon";

export default Icon24SupportIcon;
